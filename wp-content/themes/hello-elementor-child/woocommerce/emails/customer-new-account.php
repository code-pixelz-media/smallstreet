...
<p><?php printf(esc_html__(' Welcome MEGAvoter, %s,', 'woocommerce'), esc_html($user_login)); ?> to our <strong>Détente 2.0</strong> world peace initiative. </p>
<?php echo ($dongtraders_api_setting_data['dong_change_welcome_text']); ?>
